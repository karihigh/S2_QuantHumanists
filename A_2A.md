...
I started drawing the first attempts in a restaurant who's mats are a drawable sheet and they provide pencils, very appreciated (see image above). I did a very simple table to write down the data to have an overview of the amount of data collected. With this, I then imagined how does sound waves are usually represented. I thought about making each recorded data as a part of a big speaker and its expanding waves. Also I tried to draw individual modules of each day using a drawing of a siren. Because it was only a 6 day collection of the data, I felt that the individual modules didn't fill the size of the postcard, so I continued trying the waves.
...
As I was drawing several attempts of the final one I felt the need to transfer the data from the app to a spreadsheet. Nomie showed me the data only as monthly total or day per day, so it was easier to read it in a Google Sheets, which also gave me a new perspective of the data.
...
<p align="center">
  <img src="https://github.com/karihigh/s2_quanthumanists/blob/master/Documentation/deardata16.jpg?raw=true" align="middle" width="70%">
</p>

<p align="center">
  <img src="https://github.com/karihigh/s2_quanthumanists/blob/master/Documentation/deardata17.jpg?raw=true" align="middle" width="70%">
</p>
